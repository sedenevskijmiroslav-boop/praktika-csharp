...
namespace FinanceApp2
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow(ApplicationDbContext context, AuthService authService)
        {
            InitializeComponent();
            ...
            _viewModel = new MainViewModel(_transactionRepository, _authService, _reminderService);
        ...
        private async Task LoadUserDataAsync()
        {
            ...
            await _viewModel.LoadUserDataAsync(userId);
        }
